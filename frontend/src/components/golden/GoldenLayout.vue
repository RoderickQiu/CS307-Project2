...
const emit = defineEmits(['ChangeRect', 'Bind', 'Unbind', 'VisibilityChange', 'ZIndexChange']);
...
const loadGLLayout = async (
    ...
    let contents: AnyItemConfigs[] = [];
    if (config.root != undefined)
        contents.push(config.root!.content as AnyItemConfigs);
...
onMounted(() => {
    ...
    const handleContainerVirtualRectingRequiredEvent = (
        ...
        emit('ChangeRect', container, width, height);
    };
    ...
    const handleContainerVirtualVisibilityChangeRequiredEvent = (
        ...
        emit('VisibilityChange', container, visible);
    };
    ...
    const handleContainerVirtualZIndexChangeRequiredEvent = (
        ...
        emit('ZIndexChange', container, logicalZIndex, defaultZIndex);
    };
    ...
    const bindComponentEventListener = (
        ...
        emit('Bind', container, itemConfig);
